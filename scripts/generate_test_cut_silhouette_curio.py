...
def generate_test_cut_curio():
    ...
    pattern_buffer_x = 10  # mm
    pattern_buffer_y = 10  # mm
    ...
    gap_range = np.arange(0.5, 5.1, 0.5)
    ...
    #############################################################################
    x, y = 0, line_lengths[-1] + pattern_buffer_y
    line_lengths = np.arange(1., 52., 2.)
    gap_range = np.arange(0.5, 5.1, 0.5)  # = kerf width
...
if __name__ == '__main__':
    now = datetime.now()
    name_clarifier = "_test_cut_silhouette_curio"
